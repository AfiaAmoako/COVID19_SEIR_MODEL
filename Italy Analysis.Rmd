...
plot(cum.cases.italy[c(10:50), 1], cum.cases.italy[c(10:50), 2], type = 'l', xlab = "Date", ylab = "Cumulative Cases", col = "chartreuse4", lwd = 3, main = "Model Validation of \n varying R0 values ")
...
plot(X_italy_p[c(1:24), 3] ~ axis_italy_p[c(1:24)] ,  col = 'steelblue4',  lwd = 3,  type = 'l', ylab = "Number of People Infectious", xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-06-30")), ylim = c(0,10000), main = "A")
...
plot(cumsum(X_italy_p_n[c(1:152), 5]) ~ axis_italy_p[c(1:152)],  col = 'navy',  lwd = 3,  type = 'l', ylab = 'Cumulative Cases', xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-06-30")), ylim = c(0,150000), main = "B") 
#current situation
lines(cum.cases.italy[c(10:77), 2] ~ axis_italy_p[c(1:68)], col = 'chartreuse4', lwd = 3) 
#with intervetnion
