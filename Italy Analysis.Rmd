...
plot(first_beta_italy$I ~ axis_italy, type = 'l',  xlab = "Date", ylab = "Number of People Infectious", col = 'navy', lwd = 3, main = "A")
 lines(second_beta_italy$I ~ axis_italy, col = 'red', lwd = 3)
 legend("topleft", legend = c( "Model R: 3.5","Model R:2.6", "Model R: 1.5"), fill = c("navy", "red", "pink"), col = c("navy", "red", "pink"), cex = 1, box.lty = 1)

 
#"Comparing Modeled Cumulative Cases in Italy with varying R0 values to current cases",
plot(cum.cases.italy[c(10:50), 1], cum.cases.italy[c(10:50), 2], type = 'l', xlab = "Date", ylab = "Cumulative Cases", col = "chartreuse4", lwd = 3, main = "Comparing Modeled Cumulative Cases \n in Italy with varying R0 values")
...
legend("topleft", legend = c("R=3.5", "R=2.6", "R=1.5", "R=0.5", "No Intervention"), fill = c("steelblue4", "violetred4", "gold", "red", "navy"), col = c("steelblue4", "violetred4", "gold", "red", "navy"), cex = 1, box.lty = 0)

#cumulative cases comparison
#without intervention
plot(cumsum(X_italy_p_n[c(1:91), 5]) ~ axis_italy_p[c(1:91)],  col = 'navy',  lwd = 3,  type = 'l', ylab = 'Cumulative Cases', xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-04-30")), ylim = c(0,150000), main = "B") 
#current situation
...
legend("topleft", legend = c("Without Interventions", "Current Situation", "With Interventions"), fill = c("navy", "chartreuse4", "red"), col = c("navy", "chartreuse4", "red"), cex = 1, box.lty = 0)
...
plot(cumsum(X_italy_p_e[c(1:91), 5]) ~ axis_italy_p[c(1:91)] , type = 'l', col = 'pink',  lwd = 3,  ylab = 'Cumulative Cases', xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-04-30")), ylim = c(0,150000), main = "B") #with intervetnion
