...
X_italy <- array(data = 0, dim = c(niter_italy, 6, 3)) #created an array to catch the results
colnames(X_italy) <- c("S", "E", "I","R", "New Case", "New Deaths")
#low
...
for (i in 2:niter_italy) { 
  ...
  X_italy[i,3, l] <- X_italy[i-1,3, l] + dt * (alpha * X_italy[i-1,2, l] - gamma * X_italy[i-1,3, l] - mu * X_italy[i-1,3, l])  #I 
  X_italy[i,4, l] <- X_italy[i-1,4, l] + dt * (gamma * X_italy[i-1,3, l]) #R
  X_italy[i,5, l] <- dt * (alpha * X_italy[i-1,2, l]) #new cases added 
  X_italy[i,6, l] <- dt * (mu * X_italy[i-1,3, l])
  ...
  X_italy[i,3, m] <- X_italy[i-1,3, m] + dt * (alpha * X_italy[i-1,2, m] - gamma * X_italy[i-1,3, m] - mu * X_italy[i-1,3, l])  #I 
  X_italy[i,4, m] <- X_italy[i-1,4, m] + dt * (gamma * X_italy[i-1,3, m]) #R    
  X_italy[i,5, m] <- dt * (alpha * X_italy[i-1,2, m]) #new cases added
  X_italy[i,6, m] <- dt * (mu * X_italy[i-1,3, m]) #new deaths added
  ...
  X_italy[i,3, h] <- X_italy[i-1,3, h] + dt * (alpha * X_italy[i-1,2, h] - gamma * X_italy[i-1,3, h] - mu * X_italy[i-1,3, l])  #I 
  X_italy[i,4, h] <- X_italy[i-1,4, h] + dt * (gamma * X_italy[i-1,3, h]) #R
  X_italy[i,5, h] <- dt * (alpha * X_italy[i-1,2, h]) #new cases added
  X_italy[i,6, h] <- dt * (mu * X_italy[i-1,3, h]) #new deaths added
