...
plot(X_italy_p[c(1:24), 3] ~ axis_italy_p[c(1:24)] ,  col = 'steelblue4',  lwd = 3,  type = 'l', ylab = "Number of People Infectious", xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-04-30")), ylim = c(0,20000))
...
legend("topright", legend = c("R=3.5", "R=2.6", "R=1.5", "R=0.5", "No Intervention"), fill = c("steelblue4", "violetred4", "chartreuse4", "red", "pink"), col = c("steelblue4", "violetred4", "chartreuse4", "red", "pink"), cex = 0.75)



#cumulative cases comparison
#intervention: main = "Comparing the Model Interventions with Non-intervention",
plot(cumsum(X_italy_p[c(1:91), 5]) ~ axis_italy_p[c(1:91)] ,  col = 'red',  lwd = 3,  type = 'l', ylab = 'Cumulative Cases', xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-04-30")), ylim = c(0,50000)) #with intervetnion
 lines(cumsum(X_italy_p_n[c(1:91), 5]) ~ axis_italy_p[c(1:91)] , col = 'navy', lwd = 3) 
 legend("topright", legend = c("With Interventions", "Current Situation","Without Interventions"), fill = c("red", "chartreuse4" ,"navy"), col = c("red", "chartreuse4" ,"navy"), cex = 0.5)
...
#cumulative cases comparison
#intervention: main = "Comparing the Model Interventions with Non-intervention",
plot(cumsum(X_italy_p_e[c(1:91), 5]) ~ axis_italy_p[c(1:91)] , type = 'l', col = 'pink',  lwd = 3,  ylab = 'Cumulative Cases', xlab = "Time (Days)",  xlim = as.Date(c("2020-01-31", "2020-04-30")), ylim = c(0,50000)) #with intervetnion
 lines(cumsum(X_italy_p_n[c(1:91), 5]) ~ axis_italy_p[c(1:91)] , col = 'navy', lwd = 3) 
lines(cum.cases.italy[c(10:73), 2] ~ axis_italy_p[c(1:64)], col = 'chartreuse4', lwd = 3) 
lines(cumsum(X_italy_p[c(1:91), 5]) ~ axis_italy_p[c(1:91)] ,  col = 'red',  lwd = 3)
legend("topright", legend = c("With Interventions  \n", "Intervention A \n week earlier" ,"Current Situation","Without Interventions"), fill = c("red","pink", "chartreuse4" ,"navy"), col = c("red","pink", "chartreuse4" ,"navy"), cex = 0.5)
